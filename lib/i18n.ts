...
const fr: Dict = {
  ...
  welcome_signup: 'Créer un compte',
  welcome_back: 'Bon retour',
  signin_title: 'Se connecter',
  signup_title: 'Créer votre compte',
  back: 'Retour',
  phone: 'Téléphone',
  signup_pitch: 'Rejoignez des centaines de commerçants mauritaniens qui gèrent leur commerce intelligemment',
...
const en: Dict = {
  ...
  back: 'Back',
  phone: 'Phone',
  signup_pitch: 'Join hundreds of Mauritanian merchants who manage their business intelligently',
...
const ar: Dict = {
  ...
  welcome_login: 'تسجيل الدخول',
  welcome_signup: 'إنشاء حساب',
  welcome_back: 'مرحباً بعودتك',
  signin_title: 'تسجيل الدخول',
  signup_title: 'إنشاء حسابك',
  back: 'رجوع',
  phone: 'الهاتف',
  signup_pitch: 'انضم إلى مئات التجار الموريتانيين الذين يديرون تجارتهم بذكاء',
  payment_label: 'الدفع',
