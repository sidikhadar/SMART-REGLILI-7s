...
const fr: Dict = {
  ...
  tp_qty_sold: 'Quantité vendue',
  tp_stock_left: 'Stock restant',
  tp_empty: 'Aucune vente enregistrée',
  tp_units: 'u.',
  ...
  location_hint: 'Rayon 3 - Case B2',
  search_product_or_location: 'Rechercher (nom ou emplacement)…',
  lots: 'Lots',
  lot: 'Lot',
  lot_number: 'N° de lot',
  no_expiry: 'Sans date',
  ...
  inv_share: 'Partager',
  exp_export: 'Exporter',
  exp_excel: 'Exporter en Excel (.xlsx)',
  exp_pdf: 'Exporter en PDF',
  exp_sheet_name: 'Factures',
  exp_total_row: 'Total',
  exp_title_invoices: 'Liste des factures',
  exp_title_finances: 'Finances — Ventes',
  exp_col_date: 'Date',
  exp_col_number: 'N° facture',
  exp_col_client: 'Client',
  exp_col_total: 'Montant total',
  exp_col_paid: 'Montant payé',
  exp_col_method: 'Mode de paiement',
...
const en: Dict = {
  ...
  tp_revenue: 'Revenue',
  tp_qty_sold: 'Quantity sold',
  tp_stock_left: 'Stock left',
  tp_empty: 'No sales recorded',
  tp_units: 'u.',
  ...
  barcode: 'Barcode',
  location: 'Location',
  location_hint: 'Aisle 3 - Bin B2',
  search_product_or_location: 'Search (name or location)…',
  lots: 'Lots',
  lot: 'Lot',
  lot_number: 'Lot no.',
  no_expiry: 'No date',
  ...
  exp_export: 'Export',
  exp_excel: 'Export to Excel (.xlsx)',
  exp_pdf: 'Export to PDF',
  exp_sheet_name: 'Invoices',
  exp_total_row: 'Total',
  exp_title_invoices: 'Invoice list',
  exp_title_finances: 'Finances — Sales',
  exp_col_date: 'Date',
  exp_col_number: 'Invoice #',
  exp_col_client: 'Client',
  exp_col_total: 'Total amount',
  exp_col_paid: 'Amount paid',
  exp_col_method: 'Payment method',
...
const ar: Dict = {
  ...
  help_text: 'اختر صاحب المتجر ��لإد��رة الكاملة أو الصندوق للبيع. تواصل مع الدعم إذا نسيت بي��ناتك.',
  remember_me: 'تذكرني',
  ...
  tp_qty_sold: 'الكمية المباعة',
  tp_stock_left: 'المخزون المتبقي',
  tp_empty: 'لا توجد مبيعات مسجّلة',
  tp_units: 'و.',
  ...
  inv_download: 'تحميل',
  exp_export: 'تصدير',
  exp_excel: 'تصدير إلى Excel (.xlsx)',
  exp_pdf: 'تصدير إلى PDF',
  exp_sheet_name: 'الفواتير',
  exp_total_row: 'المجموع',
  exp_title_invoices: 'قائمة الفواتير',
  exp_title_finances: 'المالية — المبيعات',
  exp_col_date: 'التاريخ',
  exp_col_number: 'رقم الفاتورة',
  exp_col_client: 'العميل',
  exp_col_total: 'المبلغ الإجمالي',
  exp_col_paid: 'المبلغ المدفوع',
  exp_col_method: 'طريقة الدفع',
